...
description: "VSCode도 있고 Claude Code도 있는데, 다언어 데스크톱 IDE를 만들기 시작한 이유"
date: 2026-05-03
slug: page-ide-intro
image:
categories:
...
- **P**air — AI 동반자. 관찰자 / 대화 / 에이전트 / 튜터 네 가지 모드.
- **A**tlas — 코드 그래프 시각화. 모듈, 함수, 의존성을 공간으로.
- **G**lass — 글래스모피즘 UI. 작업 도구이면서 보고 싶은 화면.
- **E**cho — 키스트로크 타임라인. 작업의 시간축을 그대로 저장하고 되감기.
