...
기능을 붙이는 것보다 왜 그 기술이고 어떤 트레이드오프가 있는가를 먼저 묻는 쪽입니다. 어떤 비용을 감수할지 결정하는 과정 자체가 가장 재미있는 부분이라고 생각합니다.

Java로 처음 코드를 짜기 시작해 Android, Flutter, 웹과 백엔드까지 손을 넓혀왔습니다. 한 영역에 머물기보다 양쪽 끝을 모두 만져보는 쪽을 선호하고, 작은 프로젝트라도 혼자서 처음부터 끝까지 끌고 가보려고 합니다.
